...
public:
...

  {
    ...
    sprite_eye.drawJpgFile(Storage, path_jpg_eyeball);

    // 目玉を描写するSpriteを準備
    sprite_eyeball.createSprite(image_width, image_height);
    sprite_eyeball.fillScreen(TFT_WHITE);
    sprite_eyeball.drawJpgFile(Storage, path_jpg_eyeball);

    // 上瞼を描写するSpriteを準備
    sprite_upperlid.createSprite(image_width, image_height);
    sprite_upperlid.fillScreen(TFT_WHITE);
    const bool success_load_upperlid_image = sprite_upperlid.drawJpgFile(Storage, path_jpg_upperlid);
    ...
    const bool success_load_iris_image = sprite_iris.drawJpgFile(Storage, path_jpg_iris);
  ...
  void ready_for_normal_eye(const char *path_jpg_iris = "/white.jpg", const char *path_jpg_upperlid = "/white.jpg")
  {
    ...
    sprite_upperlid.fillScreen(TFT_WHITE);
    sprite_upperlid.drawJpgFile(Storage, path_jpg_upperlid);
  }
  ...
  {
    sprite_iris.fillScreen(TFT_WHITE);
    const bool success_load_iris_image = sprite_iris.drawJpgFile(Storage, path_jpg_surprised_iris);
    Serial.println(success_load_iris_image);
  ...
  {
    sprite_upperlid.fillScreen(TFT_WHITE);
    const bool success_load_angry_upperlid_image = sprite_upperlid.drawJpgFile(Storage, path_jpg_angry_upperlid);
  ...
  {
    sprite_upperlid.fillScreen(TFT_WHITE);
    const bool success_load_sad_upperlid_image = sprite_upperlid.drawJpgFile(Storage, path_jpg_sad_upperlid);
  ...
  {
    sprite_upperlid.fillScreen(TFT_WHITE);
    const bool success_load_happy_upperlid_image = sprite_upperlid.drawJpgFile(Storage, path_jpg_happy_upperlid);
