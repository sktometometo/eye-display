...
static const char FKTEST[] = "pr2_calibration_launch/FkTest";
  ...
  class FkTestRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return FKTEST; };
    virtual const char * getMD5() override { return "708e14f98ff72822d3442bcaef9c218d"; };
  ...
  class FkTestResponse : public ros::Msg
  {
    ...
    FkTestResponse():
      pos_length(0), st_pos(), pos(nullptr),
      rot_length(0), st_rot(), rot(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return FKTEST; };
    virtual const char * getMD5() override { return "e2248c2f30c5f3e010ed2e9434015c6e"; };
