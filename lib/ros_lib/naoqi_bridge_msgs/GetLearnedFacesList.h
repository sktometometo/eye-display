#ifndef _ROS_SERVICE_GetLearnedFacesList_h
#define _ROS_SERVICE_GetLearnedFacesList_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETLEARNEDFACESLIST[] = "naoqi_bridge_msgs/GetLearnedFacesList";

  class GetLearnedFacesListRequest : public ros::Msg
  {
    public:

    GetLearnedFacesListRequest()
    {
    }
    ...
    virtual const char * getType() override { return GETLEARNEDFACESLIST; };
    virtual const char * getMD5() override { return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetLearnedFacesListResponse : public ros::Msg
  {
    public:
  ...
  class GetLearnedFacesList {
    public:
    typedef GetLearnedFacesListRequest Request;
    typedef GetLearnedFacesListResponse Response;
  };
