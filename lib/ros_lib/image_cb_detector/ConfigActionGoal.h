...
namespace image_cb_detector
{
  ...
  class ConfigActionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "image_cb_detector/ConfigActionGoal"; };
    virtual const char * getMD5() override { return "47438deb496822a5e3dc575b6081de23"; };
