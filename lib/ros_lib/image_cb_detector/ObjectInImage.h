...
namespace image_cb_detector
{
  ...
  class ObjectInImage : public ros::Msg
  {
    ...
    ObjectInImage():
      header(),
      model_points_length(0), st_model_points(), model_points(nullptr),
    ...
    virtual const char * getType() override { return "image_cb_detector/ObjectInImage"; };
    virtual const char * getMD5() override { return "0996b0d8499882526b533fe6e96aa418"; };
