...
namespace interval_intersection
{
  ...
  class ConfigAction : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "interval_intersection/ConfigAction"; };
    virtual const char * getMD5() override { return "daf4f3168538603bba58f6ea42d51314"; };
