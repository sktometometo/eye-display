...
namespace interval_intersection
{
  ...
  class ConfigActionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "interval_intersection/ConfigActionGoal"; };
    virtual const char * getMD5() override { return "3b9fc6a01b069b3d8598f7752ccdee82"; };
